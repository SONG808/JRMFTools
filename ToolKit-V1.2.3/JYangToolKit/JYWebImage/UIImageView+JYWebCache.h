...
/**
 * Integrates JYWebImage async downloading and caching of remote images with UIImageView.
 *
 * Usage with a UITableViewCell sub-class:
 *
 * @code

#import <JYWebImage/UIImageView+JYWebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided jy_setImageWithURL: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView jy_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
 ...
 * if you use jy_setImage: directly.
 */
- (NSURL *)jy_imageURL;
 ...
 * @see jy_setImageWithURL:placeholderImage:options:
 */
 ...
 * @param url         The url for the image.
 * @param placeholder The image to be set initially, until the image request finishes.
 * @param options     The options to use when downloading the image. @see JYWebImageOptions for the possible values.
 */
