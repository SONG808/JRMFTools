...
typedef NS_ENUM(NSUInteger, MYMASAxisType) {
    MYMASAxisTypeHorizontal,
    MYMASAxisTypeVertical
};

@interface NSArray (MYMASAdditions)

/**
 *  Creates a MYMASConstraintMaker with each view in the callee.
